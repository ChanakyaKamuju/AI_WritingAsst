        ...
        messages: [
          {
            role: "system",
            content:
              "You are a helpful assistant that checks and corrects grammar errors in following text. Only return the corrected text without any additional comments or context.",
          },
